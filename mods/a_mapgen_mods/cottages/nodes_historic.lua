...
minetest.register_node("cottages:wagon_wheel", {
        ...
        groups = {choppy=2,dig_immediate=2,attached_node=1, not_in_craft_guide=1},
...
minetest.register_node("cottages:loam", {
	...
	groups = {snappy=2,choppy=2,oddly_breakable_by_hand=2, not_in_craft_guide=1},
        groups = {crumbly=3},
...
minetest.register_node("cottages:wool", {
		...
		tiles = {"cottages_wool.png"},
		is_ground_content = false,
		groups = {snappy=2,choppy=2,oddly_breakable_by_hand=3,flammable=3,wool=1, not_in_craft_guide=1},
})

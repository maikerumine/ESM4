...
local sand = "default:water_source"
...
--[[
	...
	{"default:blueberries", "wine:glass_wine"},
	{"default:fern_1", "wine:glass_beer"},
	{"default:fern_2", "wine:glass_beer"},
	{"default:fern_3", "wine:glass_beer"},
	{"flowers:flower_geranium", "wine:glass_mead"},
	{"default:apple", "wine:glass_cider"},
	{"default:papyrus", "wine:glass_rum"},
	{"wine:blue_agave", "wine:glass_tequila"},
	{"farming:wheat", "wine:glass_wheat_beer"},
	{"default:coral_pink", "wine:glass_sake"},
	{"default:junglegrass", "wine:glass_bourbon"},
	{"flowers:waterlily", "wine:glass_vodka"},
	{"flowers:mushroom_brown", "wine:glass_coffee_liquor"},
	{"wine:glass_champagne_raw", "wine:glass_champagne"}
}
...
minetest.register_craft({
	...
	minetest.register_craft({
		...
		recipe = {
			"wine:glass_wine", "default:papyrus"
		}
	})
-- Raw champagne
--[[
...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"cblocks:stone_yellow", "stone","cblocks:stone_magenta","cblocks:stone_violet"},
	sidelen = 16,
	fill_ratio = 0.001,
	biomes = {"desert", "desert_ocean", "sandstone_desert", "savanna", "savanna_shore","rainforest_swamp", "rainforest", "rainforest_ocean"},
...
if minetest.get_modpath("bonemeal") then
	...
	minetest.register_craft({
		...
		recipe = {
			"wine:glass_bourbon", "default:papyrus", "default:junglegrass",

...
mobs:register_mob("mobs_esmobs:jack", {
	type = "monster",
	passive = false,
...
--[[
	...
	on_die =function(self, pos)
		jacksmall = minetest.add_entity(self.object:getpos(), "mobs_esmobs:jack_junior")
		jacksmall = minetest.add_entity(self.object:getpos(), "mobs_esmobs:jack_junior")
		jacksmall = minetest.add_entity(self.object:getpos(), "mobs_esmobs:jack_junior")
		jacksmall = minetest.add_entity(self.object:getpos(), "mobs_esmobs:jack_junior")
...
mobs:spawn({
	name = "mobs_esmobs:jack",
	nodes = {"default:stone", "ethereal:gray_dirt"},
	min_light = 0,
	max_light = 6,
	chance = 3000,
...
--[[
mobs:spawn_specific("mobs_esmobs:jack", {"default:mossycobble"}, {"air"},
	0, 6, 35, 3000, 2, -1, 31000)
]]	
mobs:register_mob("mobs_esmobs:jack_junior", {
	type = "monster",
	passive = false,
	attack_type = "dogfight",
	pathfinding = 1,
	...
	--[[
	on_die =function(self, pos)
		jacksmall = minetest.add_entity(self.object:getpos(), "mobs_esmobs:little_jack")
		jacksmall = minetest.add_entity(self.object:getpos(), "mobs_esmobs:little_jack")
			ent = jacksmall:get_luaentity()
			end
		]]	

...
function scifi_nodes.register_stairs(modname, item, groups, images, description)
...
--[[
scifi_nodes.register_stairs("darkage","basalt_cobble",
	{cracky=3},
	{"darkage_basalt_cobble.png"},
	"Basalt Cobble"
)

scifi_nodes.register_stairs("darkage","slate_tale",
	{cracky=3},
	{"darkage_slate_tale.png"},
	"Slate Tale"
)

scifi_nodes.register_stairs("darkage","straw",
	 {snappy=3, flammable=2},
	{"darkage_straw.png"},
	"Straw"
)

scifi_nodes.register_stairs("darkage","stone_brick",
	{cracky=3},
	{"darkage_stone_brick.png"},
	"Stone Brick"
)

scifi_nodes.register_stairs("darkage","ors_cobble",
	{cracky=3},
	{"darkage_ors_cobble.png"},
	"Old Red Sandtone"
)

scifi_nodes.register_stairs("darkage","desert_stone_cobble",
	{cracky=3},

...
function es.register_biomes()
	...
	minetest.register_biome({
		...
		depth_top = 1,
		node_filler = "default:desertstone",
		depth_filler = 2,
		--node_stone = "",
		--node_water_top = "",
		--depth_water_top = ,
...
function es.register_mgv6_decorations()
...
function es.make_nyancat(pos, facedir, length)
...
function es.generate_nyancats(minp, maxp, seed)

...
--[[
	...
	minetest.register_biome({
		name = "stone_unter_sky",
		node_stone =  "es:air",
		--node_top = "es:air",
		--depth_top = 100,
		--node_filler = "es:air",
		--depth_filler = 300,
		node_cave_liquid = {"es:air", "es:air"},
		node_dungeon = "es:air",
		node_dungeon_alt = "es:air",
		node_dungeon_stair = "es:air",
		y_max = -18501,
		y_min = -18999,			
		heat_point = 50,
		humidity_point = 35,
	...
	minetest.register_biome({
		name = "unter_land",
		node_stone =  "default:water_source",
		--node_top = "default:meselamp",
		--depth_top = 1,
		--node_filler = "default:dirt",
		--depth_filler = 3,
		node_cave_liquid = {"default:water_source"},
		node_dungeon = "default:wood",
	...
	minetest.register_biome({
		name = "unter_end",
		node_stone =  "es:stoneblock",
		node_top = "default:sand",
		depth_top = 1,
		node_filler = "default:dirt",
		depth_filler = 3,
		node_cave_liquid = {"default:obsidian", "default:obsidian"},
		node_dungeon = "default:dirt",
		node_dungeon_alt = "default:sand",
		node_dungeon_stair = "default:apple",
		y_max = -19500,
		y_min = -19600,			
		heat_point = 50,
		humidity_point = 35,

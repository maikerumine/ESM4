minetest.register_node("mese_crystals:mese_crystal_ore1", {
	...
	paramtype = "light",
	drawtype = "mesh",
	groups = {cracky = 1,fall_damage_add_percent = 400},
	drop = "es:mesecook_crystal 1",
...
minetest.register_tool("mese_crystals:crystaline_bell", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if growth_stage > 1 then
			...
			local stack = ItemStack("es:mesecook_crystal")

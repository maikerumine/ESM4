...
local clip_nodes = {["group:cracky"]=1,["default:stone"]=1,["default:cobble"]=1,["default:stonebrick"]=1,["default:dirt"]=1,["default:glass"]=1,["default:dirt"]=1,["default:steelblock"]=1}
local time =0;
...
minetest.register_globalstep(function(dtime)
 ...
 local privs = minetest.get_player_privs(name);
	...
	player:setpos(zed)
	minetest.chat_send_all(name.. " was caught hAx0rInG inside walls at " .. p.x .. " " .. p.y .. " " .. p.z)

...
--Maikerumine edition for es mobs--20211129

mobs = {}
mobs.mod = "mrm"
mobs.version = "20211129" -- don't rely too much on this, rarely updated, if ever
...
local set_velocity = function(self, v)
	...
	local c_x, c_y = 0, 0 --; if not c_x, c_y then return end	--mm20211130
...
local monster_attack = function(self)
	...
	local s = self.object:get_pos() ; if not s then return end	--mm20211130
	local p, sp, dist
...
local mob_punch = function(self, hitter, tflp, tool_capabilities, dir)
	...
	if is_player then
		...
		self.xp_timestamp = minetest.get_us_time()  --mayremove
	end
...
function mobs:boom(self, pos, strength, fire)
	...
	if mod_explosions then
		if mobs_griefing and not minetest.is_protected(pos, "") then
--addtntmobs			mcl_explosions.explode(pos, strength, { drop_chance = 1.0, fire = fire }, self.object)
		else

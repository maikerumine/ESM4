...
local XMIN = -1470 -- Area for random spawn
local XMAX = -1200
local ZMIN = 2000
local ZMAX = 2270

local BASRAD = 84 -- Average radius at y = -32
local HEIGHT = 4448 -- Approximate height measured from y = -32
local CONVEX = 2.7 -- Convexity. <1 = concave, 1 = conical, >1 = convex
local VOID = 0.1 -- Void threshold. Controls size of central void
local NOISYRAD = 0.6 -- Noisyness of structure at base radius.

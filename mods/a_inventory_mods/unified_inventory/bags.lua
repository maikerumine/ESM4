...
-- register bag tools
minetest.register_tool("unified_inventory:small_esmmese", {
	description = "Small MESE Bag",
	inventory_image = "bags_small.png",
	groups = {bagslots=8},
})
minetest.register_tool("unified_inventory:medium_esmmese", {
	description = "Medium MESE Bag",
	inventory_image = "bags_medium.png",
	groups = {bagslots=16},
})
minetest.register_tool("unified_inventory:large_esmmese", {
...
-- register bag crafts
minetest.register_craft({
	output = "unified_inventory:small_esmmese",
	recipe = {
        {"", "default:mese", ""},

...
mobs_mc.items = {
	...
	blaze_rod = "default:mese_crystal_fragment",
	blaze_powder = "mobs_mc:blaze_powder",
	chicken_raw = "mobs:meat_raw",
	chicken_cooked = "mobs:meat",
	feather = "mobs_mc:feather",
	beef_raw = "mobs:meat_raw",
	beef_cooked = "mobs:meat",
	bowl = "mobs_mc:bowl",
	...
	nether_brick_block = "nether:netherbrick",

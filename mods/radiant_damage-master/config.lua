...
setting("bool", "enable_radioactive_damage", true, "Enable radiant radioactive damage")
setting("int", "radioactive_damage", 2, "Damage dealt per second when standing directly adjacent to one radioactive node")
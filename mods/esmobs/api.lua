...
mobs.remove = minetest.setting_getbool("remove_far_mobs") or true
			...
			elseif self.state == "attack" and self.attack_type == "explode" then
				...
				if self.attack.dist > 3 then
					...
					if self.timer > 3 then
						...
						self.object:remove()
						--mobs:explosion(pos, 2, 0, 1, "tnt_explode", self.sounds.explode)  --removed fugly
						--mobs:explode(pos, 2, 0, 1, "tnt_explode", self.sounds.explode)

...
mobs:register_spawn("esmobs:bone_monster", {"default:stone_with_iron","bones:bones","esmobs:bones", "bedrock2:bedrock","default:stone"},6, -1, 17000, 3, 30)
...
mobs:register_spawn("esmobs:dirt2", {"default:dirt_with_grass","default:stone", "default:stonebrick","default:cobble"}, 5, -1, 14000, 2, -100)
...
mobs:spawn_specific("esmobs:paniki", {"air"},{"air"}, 3, -1, 30, 8000, 1, 5, 40)

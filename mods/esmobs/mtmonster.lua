...
mobs:register_spawn("esmobs:dungeon_master", {"default:stone"}, 2, -1, 7000, 2, -70)
...
mobs:register_spawn("esmobs:stone_monster", {"default:stone", "bedrock2:bedrock"}, 5, -1, 9000, 10, 500)

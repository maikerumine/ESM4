...
minetest.register_globalstep(function(dtime)
	...
	for _,player in pairs(minetest.get_connected_players()) do
		...
		or playerplus[name].nod_stand == "default:sand"
		or playerplus[name].nod_stand == "default:desert_sand"
		or playerplus[name].nod_stand == "default:silver_sand"
		or playerplus[name].nod_stand == "es:mud"
